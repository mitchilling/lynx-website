...
Moreover, you can also implement your own feed/list interaction behavior with [MTS](/lynx-ui/Guides/MainThreadScript.html).
...
<PageTabs id="page">
  ...
  <PageTab label="How to Use `refreshOptions`">
