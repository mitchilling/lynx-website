...
除了用 AI 帮助开发者写 Lynx 代码，Lynx 也支持 AI Agent 在运行时生成界面。基于 Google 发起的 Agent-to-UI 开放协议 [A2UI](https://a2ui.org/)，Agent 输出声明式 UI 消息，由 Lynx 渲染为原生组件。

阅读 [A2UI 驱动的 Lynx 生成式界面](/blog/lynx-a2ui) 了解发布详情，或前往 [ReactLynx 中的 A2UI 指南](/react/genui/a2ui) 查看接入说明。
