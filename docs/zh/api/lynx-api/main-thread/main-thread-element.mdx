...
获取元件的 ComputedStyle。样式名需为 [kebab-case](https://developer.mozilla.org/zh-CN/docs/Glossary/Kebab_case)。

请参阅 [Element.getComputedStyleProperty](./element-get-computed-style)。
