...
在完成 [Gallery](/learn/gallery) 教程后，相信你已经掌握了 Lynx 的基础用法。接下来，让我们通过一个支付详情页面来学习一些更进阶的功能，包括：
...
Lynx 支持多种 CSS 动画集合，想了解更多动画玩法，可以看看 [CSS Animation](../../api/css/properties/animation.mdx)。
:::
...
1. 定义翻转动画：
   ...
   - [transform](../../api/css/properties/transform.mdx) 属性则定义了元件的旋转角度。
