...
The following is an example of the comprehensive use of properties. You can also refer to [text-related properties](/api/elements/built-in/text#attributes).
