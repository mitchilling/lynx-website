...
Then, refer to the [Install Dependencies & Start the Development Server](../start/quick-start#start-developing) guide to install dependencies and start the development server in the root directory of your Lynx project.
