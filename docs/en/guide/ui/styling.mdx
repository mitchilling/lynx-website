...
You can get this in [Sass](/rspeedy/styling.html#using-sass), which is already supported in ReactLynx, or other [post css plugins](/rspeedy/styling.html#using-postcss), such as [postcss-nesting](https://github.com/csstools/postcss-plugins/tree/main/plugins/postcss-nesting).
