---
description: 'Managing scrolling and overflow content using scroll-view and list elements in Lynx.'
---
...
- sticky capability：`<scroll-view>`[sticky](/api/elements/built-in/scroll-view.html#sticky-capability)；`<list>`[sticky](/api/elements/built-in/list.html#sticky-elements)

- `<list>` [paginated scrolling](/api/elements/built-in/list.html#pagination-with-item-snap)

- `<list>` [load more](/api/elements/built-in/list.html#loading-content-when-scrolling-to-edge)
