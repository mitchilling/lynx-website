...
The following lists the compatibility for some features that don't have individual sections. For the compatibility of features such as panels, please refer to the corresponding sections.
