...
- **Styles**:
  - [View and debug](#view-and-change-css) CSS rules applied to an element from all stylesheets.
  - Find any [invalid, overridden, or otherwise not working CSS](#invalid-and-declarations-with-invalid-values).
  - Modify elements by [adding declarations](#add-css-declarations-to-an-element), and [interacting with the Box model](#interact-with-elements-in-the-lynx-page-preview-window-via-the-box-model).
