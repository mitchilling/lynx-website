---
description: 'Building accessible Lynx apps with cross-platform accessibility interfaces.'
---
...
Use [`accessibilityAnnounce`](/api/lynx-api/lynx/lynx-accessibility-announce#lynx-accessibilityannounce-static-method) to make screen readers announce the specified text content, helping visually impaired users perceive interface state changes or operation results.
