...
The [NativeModule](/guide/use-native-modules.html#native-modules) Track shows the NativeModule invocation process, including JS–Native communication and data conversion. Use it to analyze native module flows and performance bottlenecks.
