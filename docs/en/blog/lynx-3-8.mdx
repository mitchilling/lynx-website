...
description: 'Lynx 3.8 starts the monthly release cadence with WebAssembly on Android, frame auto-sizing, line-aware text fitting, HarmonyOS SessionStorage, LynxEngine reuse, and DevTool protocol support.'
---
