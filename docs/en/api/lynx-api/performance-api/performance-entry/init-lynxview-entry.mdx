...
:::warning
This event has been deprecated. Related data can be obtained from [`LoadBundleEntry`](/api/lynx-api/performance-api/performance-entry/load-bundle-entry) / [`ReloadBundleEntry`](/api/lynx-api/performance-api/performance-entry/reload-bundle-entry).
:::
