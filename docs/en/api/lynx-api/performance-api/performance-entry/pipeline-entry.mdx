...
The time taken from preparing a [TemplateBundle](/api/lynx-native-api/template-bundle) to the completion of rendering elements and tags with `__lynx_timing_flag="__lynx_timing_actual_fmp"`. The data type is [`PerformanceMetric`](/api/lynx-api/performance-api/performance-metric).
...
The time taken from loading a [TemplateBundle](/api/lynx-native-api/template-bundle) to the completion of rendering elements and tags with `__lynx_timing_flag="__lynx_timing_actual_fmp"`. The data type is [`PerformanceMetric`](/api/lynx-api/performance-api/performance-metric).
...
The time taken from the user opening the page to the completion of rendering elements and tags with `__lynx_timing_flag="__lynx_timing_actual_fmp"`. The data type is [`PerformanceMetric`](/api/lynx-api/performance-api/performance-metric).
