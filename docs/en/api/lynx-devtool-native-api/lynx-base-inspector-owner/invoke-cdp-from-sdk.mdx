...
This can be used simultaneously with the [DevTool desktop application](/guide/devtool#run-lynx-devtool-desktop-application) without interfering with each other.
