...
Lynx Service provides Lynx Engine with host-specific capabilities, including image, log, and [FetchAPI](/guide/interaction/networking.html#using-fetch) capabilities.
...
If you use your own implementation of Lynx Service, please delete the [default implementation](/guide/start/integrate-with-existing-apps.html?platform=ios) provided by Lynx.
...
Replace the implementation of log service in `LynxServiceCenter` in the [integration documentation](/guide/start/integrate-with-existing-apps.html?platform=android) with your implementation.
...
Replace the implementation of log service in `LynxServiceCenter` in the [integration documentation](/guide/start/integrate-with-existing-apps.html?platform=harmony) with your implementation.
