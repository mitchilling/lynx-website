---
description: 'How to style and theme lynx-ui headless components.'
...
In the examples throughout this guide, `lynx-ui` provides the headless
composition layer, while LUNA acts as the theme layer that supplies semantic
tokens. LUNA is recommended, not required; you can bring your own token system
or none at all.
