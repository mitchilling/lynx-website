...
Beyond AI helping developers write Lynx code, Lynx also supports AI Agents generating UI at runtime. With [A2UI](https://a2ui.org/), an open Agent-to-UI protocol initiated by Google, an Agent emits declarative UI messages and Lynx renders them as native components.

Read [Generative UI on Lynx with A2UI](/blog/lynx-a2ui) for the release, or jump to the [A2UI guide under ReactLynx](/react/genui/a2ui) for integration details.
