...
Follow the [configure MCP guide](https://developers.openai.com/codex/mcp) using the standard config from above. You can also install the Lynx DevTool MCP server using the Codex CLI:
